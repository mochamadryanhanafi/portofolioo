...
<section class="mx-auto grid max-w-6xl gap-8 px-4 py-12 md:grid-cols-[1.1fr_0.9fr] md:items-center md:py-16">
  <div class="space-y-6">
    ...
    <div class="flex flex-wrap gap-3">
      ...
      <a class="focus-ring inline-flex items-center gap-2 rounded-md border border-[#cad3c6] px-4 py-3 font-semibold hover:bg-[#ecf0e8]" href={data.profile.cv_url}>
        <Download size={18} /> CV
      </a>
...
<section class="mx-auto grid max-w-6xl gap-8 px-4 py-12 md:grid-cols-[0.8fr_1.2fr]">
  <div>
